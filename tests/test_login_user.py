...
class TestLoginUser:
    ...
    def test_login_user_success(self, register_user_login_and_delete):
        response = register_user_login_and_delete[1]
    ...
    def test_login_user_with_empty_field_error(self, field, generate_user_data_and_delete):
        payload = copy.deepcopy(generate_user_data_and_delete)
